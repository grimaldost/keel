...
1. **FM-2 (MAJOR)**: Parser might pass arguments to make_record in wrong order
   ...
   - Smallest fix: Add explicit code note to §2 showing correct parameter order in acceptance criterion
...
findings:
  - id: FM-2
    ...
    evidence: spec-add-source-host-field.md § 2 has no code note showing parameter order
