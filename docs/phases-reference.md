...
| 3 Decompose | Wave/PR DAG (`series.toml`) | Spec sections stable | Each PR cites one section; deps are a DAG; **the SERIES pass certifies the generated series** (`keel decompose-check`) |
